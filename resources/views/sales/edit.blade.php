                ...
                <div class="content py-3">
                    <div class="container-fluid">
                        <div class="card card-outline card-outline rounded-0 shadow blur">
                            ...
                            <div class="card-body">
                                <div class="container-fluid">
                                    <form method="post" action="/sales/{{$sale->id}}" id="sale-form">
                                        @csrf
                                        @method("PUT")
                                            ...
                                            <div class="d-flex h-100 w-100">
                                                ...
                                                <div class="col-5 h-100">
                                                            ...
                                                            @foreach($sale->salesProducts as $salesProduct)
                                                                <tr>
                                                                    <td class="px-2 py-1 align-middle">
                                                                        <input type="hidden" name="product_id[]" value="{{ $salesProduct->product->id }}">
                                                                        <input type="hidden" name="product_price[]" value="{{$salesProduct->product->price}}">
                                                                        <input type="number" class="form-control form-control-sm rounded-0 text-center" min="0" name="product_qty[]" value="{{$salesProduct->qty}}" required>
                                                                    </td>
                                                                    <td class="px-2 py-1 align-middle" style="line-height:.9em">
                                                                        ...
                                                                        <p class="m-0 text-center"><small class="product_price">x {{ number_format ($salesProduct->product->price, 2) }}</small></p>
                                                                    </td>
                                                    ...
                                                    <h3 class="text-light w-100 d-flex">
                                                        ...
                                                        <div class="col-auto flex-shrink-1 flex-grow-1 truncate-1 text-right" id="amount">{{ number_format($sale->amount, 2) }}</div>
                                                    </h3>
                                                    ...
                                                    <h3 class="d-flex w-100 align-items-center">
                                                        ...
                                                        <div class="col-8">
                                                            <input type="text" pattern="[0-9\.]*$" class="form-control form-control-lg rounded-0 text-right" id="change" name="return" value="{{$sale->return}}" readonly />
                                                        </div>
                                                    </h3>
                                        ...
                                        <div class="card-footer py-5 text-right">
                                            <button type="submit" class="btn btn-primary rounded-0" form="sale-form">Ruaj</button>
