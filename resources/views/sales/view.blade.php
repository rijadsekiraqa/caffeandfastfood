    ...
    <div class="content py-3">
        <div class="card card-outline card-navy rounded-0 shadow">
            <div class="card-header">
                <h4 class="card-title">Sale Details: <b>{{$sale->payment_code}}</b></h4>
                <div class="card-tools">
                    <a href="./?page=sales" class="btn btn-default border btn-sm"><i class="fa fa-angle-left"></i> Kthehu Mrapa</a>
                </div>
            </div>
            <div class="card-body">
                <div class="container-fluid row justify-content-center">
                    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"  id="printout">
                        ...
                        <div class="d-flex">
                            <div class="col-auto"><b>Data:</b></div>
                        ...
                        <h4 class="d-flex border-bottom border-dark">
                            ...
                            <div class="col-3 text-center">Totali</div>
                        </h4>

                        @foreach($sale->salesProducts as $salesProduct)
                        <div class="d-flex border-bottom border-dark">
                            <div class="col-2 text-center">{{ $salesProduct->qty }}</div>
                            <div class="col-7 text-center" style="line-height:.9em">
                                <p class="m-0">{{ $salesProduct->product->name }}</p>
                                <p class="m-0"><small>x {{ number_format($salesProduct->price, 2, '.', '')}}</small></p>
                            </div>
                            <div class="col-3 text-center">{{ number_format($salesProduct->qty * $salesProduct->price, 2, '.', ',') }}
                            </div>
                        </div>
                        @endforeach
                        <h3 class="d-flex border-top border-dark">
                            <div class="col-4">Totali</div>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="col-auto ps-1 flex-shrink-1 flex-grow-1 border-bottom border-dark">{{ $sale->user->firstname }} {{ $sale->user->lastname }} </div>
                        </div>
                    </div>
                </div>
                <hr>
